...
- The repository contains no application-core agent loop yet.
...
1. Add versioned schemas, deterministic policy, validation, and regression tests for all four states.
